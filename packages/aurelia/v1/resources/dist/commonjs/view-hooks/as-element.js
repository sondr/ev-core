...
exports.AsElementViewHook = void 0;
...
var AsElementViewHook = (function () {
    ...
    AsElementViewHook = AsElementViewHook_1 = tslib_1.__decorate([
        (0, aurelia_framework_1.viewEngineHooks)()
    ], AsElementViewHook);
    return AsElementViewHook;
}());
exports.AsElementViewHook = AsElementViewHook;
