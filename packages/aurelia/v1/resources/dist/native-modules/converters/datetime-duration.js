...
localesModules.forEach(function (l) { return TimeAgo.addLocale(l); });
var DurationValueConverter = (function () {
    ...
    DurationValueConverter.configure = function (opts) {
        ...
        localesModules.forEach(function (l) {
            var locale = l.locale;
            DurationValueConverter_1.ctrs[locale] = new TimeAgo(locale);
        });
    ...
    DurationValueConverter = DurationValueConverter_1 = __decorate([
