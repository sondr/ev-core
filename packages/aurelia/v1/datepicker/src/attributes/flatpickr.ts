...
import { Options as FPOptions } from "flatpickr/dist/types/options";
export interface Instance extends FPInstance { }
export interface Options extends FPOptions { }

import { DateParseValues, dateParse, nameof } from "@ev-core/core";
